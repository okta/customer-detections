<h1><img src="https://www.okta.com/sites/default/files/Dev_Logo-01_Large-thumbnail.png" alt="OKTA" style="width:30px; height:auto; vertical-align:middle; margin-right:10px;"> Okta Security Detection Catalog</h1>
